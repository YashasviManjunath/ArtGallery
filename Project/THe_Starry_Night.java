...
class THe_Starry_Night implements ActionListener
{
        ...
        ImageIcon img=new ImageIcon("C:\\Users\\yasha\\OneDrive\\Desktop\\Just_pics\\THe_Starry_night_pg.jpg");
        ...
        rlabel1.setText("Artist: Vincent van Gogh");
       
        rlabel2.setText("Gallery: Expressions");
        rlabel3.setText("Price: Rs.10000000");
        rlabel4.setText("<HTML><b> Description: </b>The Starry Night is an<br> oil on canvas painting by Dutch<br> Post-Impressionist painter Vincent van<br> Gogh. Painted in June 1889, it depicts<br> the view from the east-facing window of<br> his asylum room at Saint-Rémy-de-<br>Provence, just before sunrise, with the <br>addition of an imaginary village.</HTML>");
        ...
        frame.setTitle("The Starry Night");
        //frame.pack();
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            Graph.painting.add("The Starry Night                        ");
