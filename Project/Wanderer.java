...
class Wanderer implements ActionListener
{
        ...
        ImageIcon img=new ImageIcon("C:\\Users\\yasha\\OneDrive\\Desktop\\Just_pics\\Wanderer_above_the_sea_of_fog_pg.jpg");
        ...
        rlabel1.setText("Artist: Caspar Friedrich");
       
        rlabel2.setText("Gallery: Blueart");
        rlabel3.setText("Price: Rs.2000000");
        rlabel4.setText("<HTML><b> Description: </b> It is an oil painting  by the<br> German Romantic artist Caspar David<br> Friedrich(1818). It has been considered one of the masterpieces of Romanticism.The figure stands in contemplation and self reflection, mesmerized by the haze of the<br> sea fog as if it were a religious and spiritual experience.</HTML>");
       
        rlabel1.setBounds(400,50,300,100);
        ...
        frame.setTitle("Wanderer above the sea of fog");
        //frame.pack();
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            Graph.painting.add("Wanderer above the sea of fog");
            Graph.price.add(2000000);
